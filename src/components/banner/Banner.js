...
const Banner=()=> {
                const [text]=useTypewriter({
                                words:["A place where dreams take flight and knowledge knows no bounds", 
                                "Embrace the journey",
...
<div className=" absolute top-0 left-52 mdl:left-96 right-96 flex justify-center items-center text-sm mt-24">
...
<div className="absolute bottom-0 left-52 mdl:left-96  right-96 flex justify-center items-center   flex-col gap-5">
                <h1 className="text-base font-medium mdl:text-2xl text-red-700">
...
<h2 className="    mt-60 text-2xl right-36 ">Our Mission </h2>
      ...
      <div className="  w-full py-20 border-b-[1px] border-b-black mt-96 grid grid-cols-1 mdl:grid-cols-3 gap-8 cursor-pointer"> 
