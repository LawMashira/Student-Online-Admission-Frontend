...
export default function ContactLeft() {
  return (
<div className='w-full lgl:w-[35%] h-full bg-gradient-to-r from-[#1e2024] to-[#23272b]
p-4 lgl:p-8 
...
<img className='w-full h-64 object-cover rounded-lg mb-2'
  ...
  <div className='flex flex-col gap-4'>
    ...
    <p className='text-xl text-gray-400 flex items-center gap-2 text-yellow-500'>
      Tel:<span className='text-lightText'> +263 (292) 233181, 233183, 234188,
                          234187
</span>  
...
<div className='flex flex-col gap-4'>
<h2 className='text-xl uppercase mb-4  text-blue-500 text-center'>FOllOW US ON
</h2>
