  ...
  return (
    ...
    <div className="w-full h-auto py-20   border-b-[1px] border-black  grid grid-cols-1  mdl:grid-cols-4 gap-8">
      <div className="w-full  h-full flex flex-col">
        ...
        <div className=" ">
          <h3 className=" text-xl uppercase text-red-600 tracking-wider">
            {" "}
            Contact Details
          </h3>

          <p className="font-medium">
            Maghandi College Cnr 12th Ave/Park Rd P.O BOX 1392 Bulawayo, Zw Tel:
            +263 (292) 233181, 233183, 234188 234187, 233709, 238674 Fax:+263
            (292) 251165
          </p>
        </div>
      ...
      <div className="w-full ">
        ...
        <ul className=" flex flex-col gap-4 font-medium   py-6  overflow-hidden">
          <a href="/about/maghandi/college">
            <li>
              {" "}
              <span className="w-full text-lg  hover:text-red-500 duration-300 cursor-pointer relative group ">
                About
              </span>
            </li>
          </a>
      ...
      <div className="w-full ">
        ...
        <div className="font-medium">
          <p>Name: Maghandi Institute of Technology</p>
          <p className="">
            Bank: CBZ Sapphire Branch Account Number: 02420583120037 Swift Code:
            COBZZWHA Branch Sort Code: 6120
          </p>
          <p>
            Bank : Stanbic Branch: Southerton Account Number: 9140003266809
            Swift Code: SBICZWHX
          </p>
          <p>finance-inquiries@hit.ac.zw</p>
        </div>
      </div>
    </div>
    </footer>
